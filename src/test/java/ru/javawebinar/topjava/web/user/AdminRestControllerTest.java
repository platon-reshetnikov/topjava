...
public class AdminRestControllerTest extends AbstractControllerTest {
    ...
    public void testCreate() throws Exception {
        User expected = new User(null, "New", "new@gmail.com", "newPass", 2300, Role.USER, Role.ADMIN);
    ...
    public void testCreateInvalidData() throws Exception {
        User expected = new User(null, null, "", "newPass", 10000, Role.USER, Role.ADMIN);
    ...
    public void testCreateDuplicate() throws Exception {
        User expected = new User(null, "User created", USER.getEmail(), "newPass", 10000, Role.USER, Role.ADMIN);
        mockMvc.perform(post(REST_URL)
                .contentType(MediaType.APPLICATION_JSON)
                .with(userHttpBasic(ADMIN))
                .content(jsonWithPassword(expected, "newPass")))
